<?php
//Creating php server connection to get access to the database stored in MySQL.
...
<head>
    ...
    <title>Lucky 7 - Accessories</title>
    <!--The below is used to link the style sheet to formulate the html template. -->
...
<body>
    <header>
        <!-- The below header code is used to generate header sections based on the account type.-->
        <ul class="navmenu">
    ...
    <section class="Accessories" id="store_accessories">
        <div class="center-text">
            <h2>Accessory <span>products</span></h2>
        </div>
        <div class="products">
            <div class="products">
                <!-- Load the MySQL connection and query.-->
                <?php
                $sql = "SELECT * FROM products where type='Accessory'";
                $result = mysqli_query($conn, $sql);
                while ($rows = mysqli_fetch_array($result)) {
                ?>
                    <!-- Adds inventory items stored in the database to the main page.-->
                    <div class="row1">
