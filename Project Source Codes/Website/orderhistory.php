...
<meta charset="UTF-8">
    ...
    <title>Lucky 7 - Order History</title>
...
<body>
<header>
  <!--Display the header menus to the user.-->
  <ul class="navmenu">
...
<!--The below class displays the user order history details in a table format.-->
<div class="full-page" id="full-page">
<h2 style="text-align:center; color: red; margin-top:100px;">Your Order History</h2>
<?php
$sql="SELECT * FROM userorderhistory where email='$_SESSION[email]'";
...
?>
  ...
  <td><?php echo $rows['orderid']?></td>
    <td><img src="<?php echo $rows['picture']?>" width="150" height="150"></td>
