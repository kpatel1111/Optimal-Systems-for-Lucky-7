...
<head>
        ...
        <title>Lucky 7 - Promotional Deals</title>
        <!-- CSS-link -->
  ...
  <body>
    ...
    <!--This class is used to display all the promotional deals to the user.-->
    <section class="FoodAndDrinks" id="FoodAndDrinks">
        <div class="center-text">
            <h2>Promotional Deal <span>products</span></h2>
        </div>
        <div class="products">
        <?php
$sql="SELECT * FROM products where type='Deal'";
...
?>
            ...
            <form method="post" action="cart.php?serialNumber=<?php echo $rows['serialNumber'];?>">
                ...
                <div class="price">
                <h4>Name: <?php echo $rows['productName']?></h4>
                <h4>Serial Number: <?php echo $rows['serialNumber']?></h4>
                <h4>Price: $ <?php echo $rows['price']?></h4>
