...
<meta charset="UTF-8">
  ...
  <body>
  <header>
<!--Display the header according to the account type.-->
<ul class="navmenu">
...
<!-- The below class will allow the user to add a new inventory item by filling product details, including name, price, or quantity.-->
<div class="full-page" style="background-color:white;">
    <div class="form-box" style="margin-top: 120px;">
	<center>
        <h1>Add New Inventory Product</h1>
		<form action="addproductdatabase.php" method="post">
			
<p>
			<label for="pictureName"></label>
			<input type="text" class="input-field"placeholder="Enter Product Picture Name/URL" name="pictureName" id="picture_name"required>
			</p>

			
<p>
			<label for="productName"></label>
			<input type="text" class="input-field"placeholder="Enter Product Name" name="productName" id="product_name"required>
			</p>
...
<p>
				...
				<input type="text" class="input-field"placeholder="Enter Product Type" name="type" id="type"required>
				</p>
